...
public class KaptchaController {
    ...
    public ResultVo checkVerificationCode(@RequestParam(value = "verificationCode") String verificationCode, HttpServletRequest httpServletRequest) {
        ...
        if (StringUtils.isEmpty(verificationCodeIn) || !verificationCodeIn.equals(verificationCode)) {
            return ResultVoUtil.error(MessageEnum.E010);
        }
